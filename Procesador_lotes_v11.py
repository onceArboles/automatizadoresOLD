...
print("OPCIÓN 3 - Procesar el lote por Merlin Predictive Search AR (QA)")
print("OPCIÓN 41 - Procesar por AWS Location Services en ESRI")
print("OPCIÓN 42 - Procesar por AWS Location Services en HERE")
