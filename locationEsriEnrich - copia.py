...
def procesar_lote_locationEsriEnrich() -> str: #esta es la función principal que llama a las otras
    ...
    cabecera_location = ["awsEsri-IN-id","awsEsri-IN-singleLine","awsEsri-CUSTOM-orden","awsEsri-Label", "awsEsri-Latitud", 
                         ...
                         "awsEsri-Relevance", "TipoGeo", "Estado", "Motivo", "awsEsri-CUSTOM-Json"]
...
def grabar_linea_location(una_lista_json, una_lista_id, una_hoja1_grabando, una_hoja2_grabando, una_hoja3_grabando):
    ...
    for json in range (0, len(una_lista_json)):
        ...
        try:
            ...
            una_hoja2_grabando.cell(row=fila_hoja23_escribiendo, column=18).value = "ERR"            
            ...
            una_hoja3_grabando.cell(row=fila_hoja23_escribiendo, column=2).value = "ERR"                      
...
def trabajar_json(un_json_location, un_json_entrada):
    ...
    # tome si o si el primer candidao antes y "-" es el 
    try:
        ...
        diccionario_candidato['id'] = un_json_entrada['id']
        diccionario_candidato['singleLine'] = un_json_entrada['singleLine']
        diccionario_candidato['label'] = "Sin resultados"
        diccionario_candidato['label'] = "Sin resultados"
        diccionario_candidato['lat'] = "Sin resultados"    
        diccionario_candidato['lon'] = "Sin resultados"
        diccionario_candidato['addressNumber'] = "Sin resultados"
        diccionario_candidato['street'] = "Sin resultados"                
        diccionario_candidato['neighborhood'] = "Sin resultados"                
        diccionario_candidato['municipality'] = "Sin resultados"
        diccionario_candidato['subregion'] = "Sin resultados"
        diccionario_candidato['region'] = "Sin resultados"
        diccionario_candidato['postalCode'] = "Sin resultados"
        diccionario_candidato['interpolated'] = "Sin resultados"
        diccionario_candidato['category'] = "Sin resultados"
        diccionario_candidato['relevance'] = "Sin resultados"
        diccionario_candidato['tipoGeo'] = "Sin resultados"
        diccionario_candidato['estado'] = "Sin resultados"
        diccionario_candidato['estado'] = "Sin resultados"
        diccionario_candidato['json'] = "Sin resultados"
        mejor_candidato[]
